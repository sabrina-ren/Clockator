...
#define kShadowAlpha 0.15f

//Blur for the shadow behind the PopoverView
#define kShadowBlur 2.f;
...
#define kGradientBottomColor [UIColor colorWithRed:0.96f green:0.96f blue:0.96f alpha:kBoxAlpha]

//top color white value in gradient bg
#define kGradientTopColor [UIColor colorWithRed:0.96f green:0.96f blue:0.96f alpha:kBoxAlpha]
